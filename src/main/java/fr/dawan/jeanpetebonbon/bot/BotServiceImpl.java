...
import fr.dawan.jeanpetebonbon.bot.enums.BotCommand;
import fr.dawan.jeanpetebonbon.bot.guild.Guild;
import fr.dawan.jeanpetebonbon.bot.guild.GuildRepository;
import fr.dawan.jeanpetebonbon.core.exception.DateTimeBeforeException;
import fr.dawan.jeanpetebonbon.core.exception.NoServerFound;
import fr.dawan.jeanpetebonbon.core.exception.NoTextChannelException;
import fr.dawan.jeanpetebonbon.core.tools.RandomUtils;
import fr.dawan.jeanpetebonbon.message.clash.MessageClashTrollRepository;
import fr.dawan.jeanpetebonbon.message.reaction.MessageReactionTroll;
import fr.dawan.jeanpetebonbon.message.reaction.MessageReactionTrollRepository;
...
public class BotServiceImpl extends ListenerAdapter implements BotService {
  public static final float PERCENTAGE_TROLL_REACTION = 0.2f;
  public static final float PERCENTAGE_TROLL_MESSAGE = 0.2f;
